...
<body>
    ...
    <div class="container">
        ...
        $aApresentacao = [
            ...
            'Aluno da 4º Fase do curso de Sistemas de Informação da UNIDAVI',
        ];
        $aTextos = [
    ...
    <?php
    $aBlockquote = [
        'COMO PODE O GRÊMIO, QUE ESTÁ COM A ZAGA RESERVA, ESTAR GANHANDO DA UNIVERSIDAD CATÓLICA POR 2X0 COM GOL DO ZAGUEIRO?',
        'Eu,',
        'Vendo o Avaí perder 8 gols no segundo tempo contra o Figueirense',
    ];
